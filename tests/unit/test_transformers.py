...
class TestTransformationRule:
    ...
    def test_default_values(self):
        ...
        rule = TransformationRule(
            name="test_rule", transformation_type=TransformationType.FIELD_MAPPING
        )
...
class TestFieldMapper:
    ...
    def test_remove_unmapped_fields(self):
        ...
        config = {"field_mappings": {"old_field": "new_field"}, "remove_unmapped": True}
        mapper = FieldMapper("test_mapper", config)
    ...
    def test_case_transformation(self):
        ...
        config = {"field_mappings": {"OldField": "NewField"}, "case_transform": "lower"}
        mapper = FieldMapper("test_mapper", config)
...
class TestTypeConverter:
    ...
    def test_datetime_conversion(self):
        ...
        data = {"timestamp": "2024-01-01 12:00:00", "date_field": "2024-01-01"}
        result = converter.transform(data)
    ...
    def test_error_handling_modes(self):
        ...
        # Test warn mode
        config = {"type_mappings": {"field": "int"}, "handle_errors": "warn"}
        converter = TypeConverter("test_converter", config)
...
class TestCustomTransformer:
    ...
    def test_pre_and_post_processing(self):
        ...
        config = {"pre_process_function": pre_func, "post_process_function": post_func}
        transformer = CustomTransformer("test_transformer", config)
    ...
    def test_error_handling(self):
        ...
        config = {"transform_function": failing_func, "error_handler": error_handler}
        transformer = CustomTransformer("test_transformer", config)
