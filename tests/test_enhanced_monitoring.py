...
class TestConnectionMonitor:
    ...
    def test_record_connection_event(self):
        ...
        monitor.record_connection_event(
            "test_service", "error", {"error": "Test error"}
        )
...
class TestHealthTracker:
    ...
    def test_set_service_status(self):
        ...
        # Set error status
        tracker.set_service_status(
            "test_service", ServiceStatus.ERROR, {"error": "Test error"}
        )
    ...
    def test_record_error_and_warning(self):
        ...
        tracker.record_warning(
            "test_service", "Test warning", {"details": "Warning details"}
        )
    ...
    def test_get_health_summary(self):
        ...
        tracker.set_service_status(
            "service2", ServiceStatus.ERROR, {"error": "Test error"}
        )
