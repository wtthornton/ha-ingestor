...
class InfluxDBWriter:
    ...
    async def analyze_schema_optimization(self) -> dict[str, Any]:
        ...
        try:
            ...
            schema_config = {
                ...
                "tag_compression_threshold": self.config.influxdb_tag_compression_threshold,
                "field_compression_threshold": self.config.influxdb_field_compression_threshold,
