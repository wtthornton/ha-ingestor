...
class WebSocketEvent(Event):
    ...
    source: Literal["websocket"] = Field(default="websocket", description="Event source")
    ...
    def validate_event_type(cls, v: str) -> str:
        ...
        common_event_types = {
            "state_changed", "automation_triggered", "service_called", 
            "event", "call_service", "fire_event", "user_updated",
    ...
    def validate_entity_id(cls, v: Optional[str]) -> Optional[str]:
        ...
        if not re.match(r"^[a-z0-9_]+$", entity_id):
            raise ValueError("Entity ID must contain only lowercase letters, numbers, and underscores")
    ...
    def validate_data(cls, v: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for key, value in v.items():
            ...
            try:
                ...
                raise ValueError(f"Event data value for '{key}' is not JSON serializable")
        
        return v
    
    @classmethod
    def from_websocket_message(cls, message: Dict[str, Any], timestamp: Optional[datetime] = None) -> "WebSocketEvent":
    ...
    def get_state_change_info(self) -> Optional[Dict[str, Any]]:
    ...
    def get_service_call_info(self) -> Optional[Dict[str, Any]]:
    ...
    def get_automation_info(self) -> Optional[Dict[str, Any]]:
