...
class FilterResult:
    ...
    should_process: bool
    transformed_event: Event | None = None
    filter_name: str = ""
...
class Filter(ABC):
    ...
    async def process(self, event: Event) -> FilterResult:
        ...
        try:
            ...
            self.logger.error(
                "Error processing event in filter", filter_name=self.name, error=str(e)
            )
...
class FilterChain:
    ...
    def __init__(self, filters: list[Filter] | None = None, name: str = "filter_chain"):
    ...
    async def process_event(self, event: Event) -> Event | None:
    ...
    def get_stats(self) -> dict[str, Any]:
        ...
        return {
            ...
            "filter_rate": self._total_filtered
            / max(self._total_processed + self._total_filtered, 1),
